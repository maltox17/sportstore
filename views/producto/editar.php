<div class="container mt-5">
    <div class="row mb-4">
        <div class="col-md-6 m-auto">
            <div class="card">
                <h4 class="card-title text-center mt-3">Editar Producto <?=$pro->nombre?></h4>
                <div class="card-body">
                    ...
                    <form action="<?= base_url ?>producto/save&id=<?=$pro->id;?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" id="form1Example2" class="form-control" name="nombre" required value=<?=$pro->nombre?> />
                        ...
                        <div class="form-outline mb-4">
                            <textarea class="form-control" id="form4Example3" rows="4" name="descripcion" required><?=$pro->descripcion?></textarea>
                        ...
                        <div class="form mb-4">
                            <label class="form-label pl-1" for="form1Example2">Precio</label>
                            <input type="number" id="form1Example2" class="form-control border rounded" name="precio" required value=<?=$pro->precio?> />
                            
                        </div>

                        <div class="form-outline mb-4">
                            <label class="form-label" for="form1Example2">Stock</label>
                            <input type="number" id="" class="form-control border rounded" name="stock" required value=<?=$pro->stock?> />
                            
                        </div>
                        <?php if(!empty($pro->imagen)) : ?>
                            <img src="<?=base_url?>uploads/images/<?=$pro->imagen?>" width='50'></img>
                        <?php endif;?>
                        <div class="form-outline mb-4">
